                        ...
                        <div style={{margin: "7%"}}>
                            ...
                            <Form>
                                ...
                                <span className="input-group-text"
                                    ...
                                    <Field id="birthdayFrom" name="birthdayFrom" type="number" className="form-control"
                                           style={{
                                               borderTopRightRadius: "20px",
                                               borderBottomRightRadius: "20px"
                                           }}/><br/>
                                ...
                                <span className="input-group-text"
                                    ...
                                    <Field id="birthdayEnd" name="birthdayEnd" type="number" className="form-control"
                                           style={{
                                               borderTopRightRadius: "20px",
                                               borderBottomRightRadius: "20px"
                                           }}/><br/>
                                ...
                                <span className="input-group-text"
                                    ...
                                    <ErrorMessage name="job" component="span" style={{color: "red"}}></ErrorMessage>
                                </div>
                                <div className="input-group mb-3">
                                ...
                                >
                                    ...
                                    <ErrorMessage name="hobby" component="span" style={{color: "red"}}></ErrorMessage>
                                </div>
