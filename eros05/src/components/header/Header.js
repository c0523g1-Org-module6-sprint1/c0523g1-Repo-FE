...
export default function Header() {
  ...
  return (
    <header className="header">
      ...
      />
      <LogoutConfirmModal show={isShowModal} handleCloseFn={closeModal} />
      <div className="container">
        <nav className="navbar navbar-expand-lg navbar-light">
          ...
          <div
            className="ms-2 collapse navbar-collapse navbar-middle"
          ...
          >
            {isAuthentication ? (
              <ul className="navbar-nav me-auto mb-2 mb-lg-0  navbar-login-items">
                ...
                <li className="nav-item">
                  <Link
                    to="/invited_recommend_friend/RecommendList"
                    className="nav-link icon"
                    aria-current="page"
                  >
                        ...
                        <div className="box">
                          <div className="display">
                            <div className="nothing">
                              <h3 className="cent">không có quà tặng</h3>
                            </div>
                            <div className="cont">
